...
- **Figures**: 3D scenes (complex/pocket/interaction) need PyMOL; 2D interaction diagram needs RDKit. Interaction scene shows an 8 Å pocket window with side-chain sticks; multi-ring ligands get light-grey fill on non-interacting aromatic rings. Verify figure quality visually before publication — do not ship unviewed PNGs.
